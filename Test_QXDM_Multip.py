...
import time
from multiprocessing import Process, Pool, freeze_support, Lock, Manager
import gc
import psutil
...
# handle = autoWindow.LoadItemStore(INPUT_FILE)
# total_itemcounts = autoWindow.GetItemCount()
...
def QXDM_Logging_Packet_Multiprocessing():
    # gc.collect()
    # Time_1 = time.time()
    # print('Time1:', Time_1)
    # manager = Manager()
    ...
    # handle = autoWindow.LoadItemStore(INPUT_FILE)  # load ISF file
    # global total_itemcounts
    # global total_itemcounts  # Get item counts of the ISF file
    # print(total_itemcounts)
    ...
    for i in range(0, 100):
        ...
        obj_item = i
        pT = pool.apply_async(QXDM_Logging_Packet_TestMode, (obj_item,))
...
def QXDM_Logging_Packet_TestMode(val):
    # print('tp0001')
    print('test_tp1:\t', val)
    #process_name = 'QXDM.exe'
    # lock.acquire()
    ...
    # global total_itemcounts
    # total_itemcounts = autoWindow.GetItemCount()  # Get item counts of the ISF file
    QxdmApp_1 = Dispatch("QXDM.QXDMAutoApplication")  # Initialize QXDM
    autoWindow_1 = QxdmApp_1.GetAutomationWindow()
    print("QXDM version: " + autoWindow_1.AppVersion)
    print("Open Log: " + INPUT_FILE)
    handle_1 = autoWindow_1.LoadItemStore(INPUT_FILE)  # load ISF file
    ## global total_itemcounts
    total_itemcounts_1 = autoWindow_1.GetItemCount()  # Get item counts of the ISF file
    print(total_itemcounts_1)
    ...
    item = autoWindow_1.GetItem(handle_1, val)
    # print(item)
...
if __name__ == '__main__':
    ...
    #    # Time_1 = time.time()
    #    # print('Time1:', Time_1)
    #    process_Test = Process(target=QXDM_Logging_Packet_TestMode, args=(obj_item,))
    #    # pT = pool_Test.apply_async(QXDM_Logging_Packet_TestMode, (obj_item,))
    #    eddy_poolcounts.append(process_Test)
    #    # eddy_poolcounts.append(pT)
    #    # eddy_poolcounts += [pT]
    #    # time.sleep(3)
    #    # print(eddy_poolcounts)
    ...
    Time_1 = time.time()
    print('Time1:', Time_1)
    QXDM_Logging_Packet_Multiprocessing()
    Time_2 = time.time()
    print('Time1:', Time_1)
    print('Time2:', Time_2)
